export default {
  headings: [
    'ספר יצירה',
    'מיוחס לאברהם אבינו',
    'ערך פיטר היימן עריכה אקדמאית עפ״י הנוסח הקדום ביותר שנמצא',
    'העלה לרשת אור לנדאו',
  ],
  book    : {
    digits    : {
    ...
    doubles   : {
      heading: 'כפולות',
      code   : [
        'שבע כפולות בגד כפרת מתנהגות בשתי לשונות חיים ושלום וחכמה ועושר חן זרע ממשלה ומתנהגות בשתי לשונות בּי בי גּימל גימל דּלת דּלת כּף כּף פּי פי רּיש ריש תּיו תיו רק וקשה גיבור וחלש',
